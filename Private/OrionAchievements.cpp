...
void AOrionAchievements::Init()
{
	...
	Achievements.Add(FAchievement(ACHCATEGORY_MISC, TEXT("WELCOME TO WHITEOUT"), TEXT("welcometowhiteout"), TEXT("COMPLETE A SURVIVAL MATCH ON WHITEOUT"), ACH_WELCOMETOWHITEOUT, -1, 1, NULL, TEXT(""), 100));
	Achievements.Add(FAchievement(ACHCATEGORY_MISC, TEXT("WELCOME TO HAVEN"), TEXT("welcometohaven"), TEXT("COMPLETE A SURVIVAL MATCH ON HAVEN"), ACH_WELCOMETOHAVEN, -1, 1, NULL, TEXT(""), 100));
	...
	Achievements.Add(FAchievement(ACHCATEGORY_CHALLENGES, TEXT("WHITEOUTICULOUS"), TEXT("whiteouticulous"), TEXT("WIN A REDIKULOUS SURVIVAL MATCH ON WHITEOUT"), ACH_REDIKULOUSWHITEOUT, -1, 1, NULL, TEXT(""), 1000));
	Achievements.Add(FAchievement(ACHCATEGORY_CHALLENGES, TEXT("HAVENICULOUS"), TEXT("haveniculous"), TEXT("WIN A REDIKULOUS SURVIVAL MATCH ON HAVEN"), ACH_REDIKULOUSHAVEN, -1, 1, NULL, TEXT(""), 1000));
	...
	Achievements.Add(FAchievement(ACHCATEGORY_CHALLENGES, TEXT("THE 600 ITEM LEVEL MAN"), TEXT("600man"), TEXT("EQUIP A FULL SET OF LEGENDARY ITEM LEVEL 600 GEAR"), ACH_600MAN, -1, 1, NULL, TEXT(""), 2500));
