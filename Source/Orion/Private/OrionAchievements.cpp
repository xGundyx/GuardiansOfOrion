...
void AOrionAchievements::Init()
{
	...
	Achievements.Add(FAchievement(ACHCATEGORY_CHALLENGES, TEXT("MONSTER FRAG"), TEXT("monsterfrag"), TEXT("KILL AT LEAST 10 ENEMIES WITH A SINGLE FRAG GRENADE"), ACH_MONSTERFRAG, -1, 1, NULL, TEXT(""), 250));
	...
	Achievements.Add(FAchievement(ACHCATEGORY_CHALLENGES, TEXT("DISMEMBERER"), TEXT("dismemberer"), TEXT("AS A TEAM, BLOW 500 LIMBS AND HEADS OFF ENEMIES IN A SINGLE MATCH"), ACH_DISMEMBERER, -1, 1, NULL, TEXT(""), 250));
